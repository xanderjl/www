...
export const CoffeeBean: Component<ComponentProps<"svg">> = (props) => (
  <svg
    fill="currentColor"
    version="1.1"
    id="Capa_1"
  ...
  >
    <g>
      <path
        d="M14.257,275.602C-17.052,220.391,4.253,133.798,69.023,69.01c73.553-73.543,175.256-91.076,227.182-39.16
